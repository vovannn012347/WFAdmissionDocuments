...
namespace WFAdmissionDocuments.Templates.TemplateElements
{
    ...
    public class TextMultipartTemplateElement : Label, ITextTemplateElement, ITemplateKeyElement
    {
        ...
        private static List<ElementPropertyProperties> PopertyDefs =
            new List<ElementPropertyProperties>{
                ...
                PropertyDictionary.Get(typeof(MultipartGroupKeyProperty)),
                PropertyDictionary.Get(typeof(MultipartGroupKeyOrderProperty)),
        ...
        [Browsable(true)]
        [Description("Multipart group key (for spreading text between parts)")]
        public string MultipartGroupKey { get; set; }

        [Browsable(true)]
        [Description("Multipart group fill order")]
        ...
        public TextMultipartTemplateElement()
        {
        ...
        {
            return new KeyedMultipartTextTemplate();
        }
    }
}
